...
class RandomBertLanguageModelingDataset(Dataset):
    """Dataset representing a set of randomly generated peptides"""
    ...
    def __init__(self, split: str, data_path: Union[str, Path], in_memory: bool=False, maxlen=200, percent_reduction=1, **kwargs):
        ...
        data_file = f'random_peptide_{split}.lmdb' #oas_heavy_
